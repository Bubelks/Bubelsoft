///<amd-module name="app"/>
define("app", ["require", "exports", "home/home", "company/companyApp", "buildings/buildingsApp", "user/userApp", "utils/router", "knockout", "utils/navigator"], function (require, exports, home_1, companyApp_1, buildingsApp_1, userApp_1, router_1, ko, navigator) {
    "use strict";
...
define("user/userApp", ["require", "exports", "utils/router", "user/register/register", "user/logIn/logIn", "knockout", "utils/navigator"], function (require, exports, router_1, register_1, logIn_1, ko, navigator) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var UserApp = (function () {
        function UserApp() {
            ...
            this.router.add("user/logIn", function () { return _this.showLogIn(); });
            this.router.start();
        }
        UserApp.prototype.showLogIn = function () {
            var _this = this;
            this.hideAll();
        ...
        UserApp.prototype.authorize = function () {
            navigator.navigate("home");
        };
        UserApp.prototype.hideAll = function () {
            if (this.logIn() !== null) {
                this.logIn().dispose();
                this.logIn(null);
            }
    ...
    var Building = (function () {
        function Building(buildingId) {
            ...
            this.getCompanies(buildingId)
                ...
                _this.reports(new reports_1.Reports(buildingId, data));
            });
        }
...
define("user/logIn/logIn", ["require", "exports", "knockout", "utils/communication/rest"], function (require, exports, ko, rest) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LogIn = (function () {
...
define("user/register/register", ["require", "exports", "utils/communication/rest", "knockout", "utils/navigator"], function (require, exports, rest, ko, navigator) {
    ...
    var RegisterUser = (function () {
        ...
        RegisterUser.prototype.dispose = function () {
        };
        return RegisterUser;
    }());
...
define("buildings/building/estimation/estimation", ["require", "exports", "utils/communication/rest", "knockout"], function (require, exports, rest, ko) {
    ...
    var Estimation = (function () {
        function Estimation(buildingId, companies) {
            ...
            this.changePage = function (choosenPage) {
                _this.currentPage(choosenPage);
                _this.visiblePages([]);
                for (var i = _this.currentPage() - 4 < 1 ? 1 : _this.currentPage() - 4; i < ((_this.currentPage() + 4) > _this.maxPage ? _this.maxPage : (_this.currentPage() + 4)); i++)
                    _this.visiblePages.push(i);
                _this.getEstimations(_this.buildingId)
                    .done(function (data) {
                    return _this.estimations(data.estimations);
                });
            };
            this.closeModal = function () {
            ...
            this.getEstimations(buildingId)
                ...
                _this.maxPage = (data.count / 30) + 1;
                for (var i = _this.currentPage() - 4 < 1 ? 1 : _this.currentPage() - 4; i < ((_this.currentPage() + 4) > _this.maxPage ? _this.maxPage : (_this.currentPage() + 4)); i++)
                    _this.visiblePages.push(i);
                _this.estimations(data.estimations);
            });
        }
...
define("buildings/building/report/report", ["require", "exports", "knockout", "utils/communication/rest"], function (require, exports, ko, rest) {
    ...
    var Report = (function () {
        function Report(buildingId, reportId) {
            ...
            var _this = this;
            this.chooseEstimation = function (newEstimation) {
                _this.newWorkEstimate(newEstimation);
        ...
        Report.prototype.filterEstimations = function (_, event) {
            var text = event.target.value.toLowerCase();
            this.visibleEstimations(this.estimations().filter(function (e) { return e.displayValue.toLowerCase().indexOf(text) > -1; }));
        };
...
define("buildings/building/reports/reports", ["require", "exports", "knockout", "utils/communication/rest"], function (require, exports, ko, rest) {
    ...
    var Reports = (function () {
        function Reports(buildingId, companies) {
            var _this = this;
            this.types = [
                {
            ...
            this.onSave = function (estimation) {
                rest.post("buildings", _this.buildingId + "/estimations/" + estimation.estimationId, estimation);
                _this.closeModal();
                _this.refresh();
            };
            this.modalOpen = ko.observable(false);
        ...
        Reports.prototype.refresh = function () {
            var _this = this;
            this.loading(true);
            this.getReports().done(function (data) {
                _this.visiblePages([]);
                _this.count(data.count);
                _this.maxPage = (data.count / 30) + 1;
                for (var i = _this.currentPage() - 4 < 1 ? 1 : _this.currentPage() - 4; i <= ((_this.currentPage() + 4) > _this.maxPage ? _this.maxPage : (_this.currentPage() + 4)); i++)
                    _this.visiblePages.push(i);
                _this.estimationsReport(data.reports.map(function (d) { return new EstimationReport(d); }));
                _this.loading(false);
            });
        };
