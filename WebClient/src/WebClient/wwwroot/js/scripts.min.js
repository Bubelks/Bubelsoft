///<amd-module name="app"/>
define("app", ["require", "exports", "home/home", "logIn/logIn", "company/company", "buildings/building", "utils/router", "knockout"], function (require, exports, home_1, logIn_1, company_1, buildingsApp_1, router_1, ko) {
    "use strict";
...
define("buildings/building", ["require", "exports", "utils/router", "buildings/create/create", "knockout"], function (require, exports, router_1, create_1, ko) {
    ...
    var BuildingsApp = (function () {
        ...
        BuildingsApp.prototype.goToCreate = function () {
        ...
        BuildingsApp.prototype.showCreate = function (buildingId) {
            ...
            this.create(new create_1.Create());
        };
...
define("buildings/create/create", ["require", "exports", "buildings/create/steps/estimate", "buildings/create/steps/building", "buildings/create/steps/company", "knockout"], function (require, exports, estimate_1, building_1, company_1, ko) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Create = (function () {
        function Create() {
            this.buildingStep = new building_1.BuildingStep();
            this.estimateStep = new estimate_1.EstimateStep(this.buildingStep);
            this.companyStep = new company_1.CompanyStep(this.buildingStep);
            this.buildingStep.setNext(this.estimateStep);
            this.buildingStep.setBack(this.companyStep);
            this.currentStep = ko.observable(this.companyStep);
