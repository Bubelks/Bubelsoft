///<amd-module name="app"/>
define("app", ["require", "exports", "home/home", "logIn/logIn", "company/company", "utils/router", "knockout"], function (require, exports, home_1, logIn_1, company_1, router_1, ko) {
    "use strict";
    ...
    var App = (function () {
        ...
        App.prototype.showBuildings = function () {
            this.hideAll();
            this.buildings(new home_1.Home());
        };
